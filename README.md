...
- **Өч язу** — `AYDA_ALIF=cyrl|latin|arab`: кирилл, Яңалиф (латин), гарәп (иске
  имля, бизәкле). `ayda kürsät kuzaklar` — латинча керем дә эшли (кириллсыз клавиатура).
